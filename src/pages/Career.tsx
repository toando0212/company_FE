      ...
      <section className="career-section">
        <div className="container">
          <div className="section-header">
            <h2>Join Our Team</h2>
            <p>Explore career opportunities with us. Check out our open positions and apply to join our team!</p>
          </div>
            ...
            <div className="career-list-grid">
              {positions.map((pos, idx) => (
                <div key={idx} className="career-item">
                  ...
                  <Link to="/contact" className="career-item__btn">Apply Now</Link>
                </div>
              ))}
            </div>
          </div>
